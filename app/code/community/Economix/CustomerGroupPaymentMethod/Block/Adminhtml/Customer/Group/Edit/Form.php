...
class Economix_CustomerGroupPaymentMethod_Block_Adminhtml_Customer_Group_Edit_Form extends Mage_Adminhtml_Block_Customer_Group_Edit_Form
{
    protected function _prepareLayout()
    {
        ...
        $fs = $form->addFieldset('payment_method', array(
            'legend' => $this->__('Payment Methods')
        ));
        
        $fs->addField('economix_customergroup_paymentmethod_disable_default_methods', 'select',
            array(
                ...
                'note'     => $this->__('"Yes" will disable all default enabled payment methods, enabling <b>only</b> following selected payment methods'),
                'values'   => array(
                    0 => $this->__('No'),
                    1 => $this->__('Yes')
                ),
        ...
        $fs->addField('economix_customergroup_paymentmethod', 'multiselect',
            array(
                'name'     => 'economix_customergroup_paymentmethod',
                'label'    => $this->__('Available Methods'),
                'title'    => $this->__('Available Methods'),
                'note'     => $this->__('Select available payment methods for this group<br /><b>ATTENTION:</b> Selected methods have to be configured in System / Configuration / Sales / Payment Methods'),
